...
public class NamingConventions { //2
    public static void main(String[] args) {

        //Java Naming Convention: Java naming convention is a rule to follow as you decide what to name your identifiers such as class, package, variable, constant, method, etc.
